...
// Make a array of your favorite fruits, and then write a series of independent if
...
let favoriteFruits = ["mango", "Banana" ,"WaterMellon"];
if(favoriteFruits.includes("WaterMellon")){
